...
with a as (
	...
	join udb_ctheis..RA_2013_Demo		i	on	fc.Indv_Sys_Id		=	i.UniqueMemberID
	where d.YEAR_NBR	=	2013
	)
select UniqueMemberID, ICDCd, 
	DiagnosisServiceDate	=	min(Full_DT)
into udb_ctheis..RA_2013_Diag
from (
	select 
...
exec RA_Commercial_2014..spRAFDiagInput 'udb_ctheis..RA_2013_Demo','udb_ctheis..RA_2013_Diag','udb_ctheis','2013'